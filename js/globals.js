function initGlobals(){
    ...
    var _globals = {
        ...
        /**
         * global variables might include things like the size of the paper, 
         * the type of paper texture, or the units used for measurements. By using the globals 
         * module, the user can modify these variables and see the effects on the virtual origami
         *  model in real-time.
         */
